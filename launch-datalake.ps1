...
if (-not (Test-Path -Path ".env")) {
    Write-Host "The .env file is missing. Please create one from the .env.example file." -ForegroundColor Red
    exit 1
}
...
Write-Host "`n🎉 Data Lake is ready!" -ForegroundColor Green
...
Write-Host "  Airflow:        http://localhost:8082" -ForegroundColor Yellow
Write-Host "  Jupyter Lab:    http://localhost:8888" -ForegroundColor Yellow
